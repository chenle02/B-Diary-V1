package com.chenboda01.bdiaryv1;
...
public class MainActivity extends Activity {
    ...
    public class AndroidBridge {
        ...
        public void copyText(String text) {
            runOnUiThread(() -> {
                ...
                cb.setPrimaryClip(ClipData.newPlainText("B-Diary V1", text));
    ...
    public void onBackPressed() {
        webView.evaluateJavascript("window.bdiaryBack && window.bdiaryBack()", null);
    }
}
